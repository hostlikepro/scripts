...
if [[ $EUID -ne 0 ]]; then
 ...
 wget https://raw.githubusercontent.com/hostlikepro/linux-install-scripts/main/web/sshd_config
 ...
 wget https://raw.githubusercontent.com/hostlikepro/linux-install-scripts/main/web/vsftpd.conf
 rm /etc/vsftpd.conf
 mv vsftpd.conf /etc/
 wget https://raw.githubusercontent.com/hostlikepro/linux-install-scripts/main/web/ftpusers
 rm /etc/ftpusers
 mv ftpusers /etc/
